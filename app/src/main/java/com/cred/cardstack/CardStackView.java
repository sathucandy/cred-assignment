...
import com.cred.cardstack.adapter.AnimatorAdapter;
import com.cred.cardstack.adapter.StackAdapter;
import com.cred.cardstack.adapter.UpDownStackAnimatorAdapter;
...
public class CardStackView extends ViewGroup implements ScrollDelegate {
    ...
    public void setAnimationType() {
        AnimatorAdapter animatorAdapter = new UpDownStackAnimatorAdapter(this);
    ...
    private void setClickAnimator(final ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(v -> performItemClick(holder));
    }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        protected VH createView(ViewGroup parent, int viewType) {
